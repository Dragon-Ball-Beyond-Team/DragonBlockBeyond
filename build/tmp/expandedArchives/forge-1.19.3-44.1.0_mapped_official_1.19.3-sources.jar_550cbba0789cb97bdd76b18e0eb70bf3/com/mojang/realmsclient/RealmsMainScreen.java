...
public class RealmsMainScreen extends RealmsScreen {
   ...
   public void addButtons() {
      this.leaveButton = this.addRenderableWidget(Button.builder(Component.translatable("mco.selectServer.leave"), (p_86679_) -> {
         this.leaveClicked(this.getSelectedServer());
      }).bounds(this.width / 2 - 190, this.height - 32, 90, 20).build());
      this.configureButton = this.addRenderableWidget(Button.builder(Component.translatable("mco.selectServer.configure"), (p_86672_) -> {
         this.configureClicked(this.getSelectedServer());
      }).bounds(this.width / 2 - 190, this.height - 32, 90, 20).build());
      this.playButton = this.addRenderableWidget(Button.builder(Component.translatable("mco.selectServer.play"), (p_86659_) -> {
         this.play(this.getSelectedServer(), this);
      }).bounds(this.width / 2 - 93, this.height - 32, 90, 20).build());
      this.backButton = this.addRenderableWidget(Button.builder(CommonComponents.GUI_BACK, (p_86647_) -> {
         if (!this.justClosedPopup) {
            this.minecraft.setScreen(this.lastScreen);
         }

      }).bounds(this.width / 2 + 4, this.height - 32, 90, 20).build());
      this.renewButton = this.addRenderableWidget(Button.builder(Component.translatable("mco.selectServer.expiredRenew"), (p_86622_) -> {
         this.onRenew(this.getSelectedServer());
      }).bounds(this.width / 2 + 100, this.height - 32, 90, 20).build());
   ...
   class CloseButton extends Button {
      public CloseButton() {
         super(RealmsMainScreen.this.popupX0() + 4, RealmsMainScreen.this.popupY0() + 4, 12, 12, Component.translatable("mco.selectServer.close"), (p_86775_) -> {
      ...
      public void renderButton(PoseStack p_86777_, int p_86778_, int p_86779_, float p_86780_) {
         ...
         blit(p_86777_, this.getX(), this.getY(), 0.0F, f, 12, 12, 12, 24);
   ...
   class NewsButton extends Button {
      public NewsButton() {
         super(RealmsMainScreen.this.width - 115, 6, 20, 20, Component.translatable("mco.news"), (p_86804_) -> {
            if (RealmsMainScreen.this.newsLink != null) {
               RealmsMainScreen.this.minecraft.setScreen(new ConfirmLinkScreen((p_258098_) -> {
                  if (p_258098_) {
      ...
      public void renderButton(PoseStack p_86806_, int p_86807_, int p_86808_, float p_86809_) {
         RealmsMainScreen.this.renderNews(p_86806_, p_86807_, p_86808_, RealmsMainScreen.this.hasUnreadNews, this.getX(), this.getY(), this.isHoveredOrFocused(), this.active);
      }
   }
   ...
   class PendingInvitesButton extends Button {
      ...
      public void renderButton(PoseStack p_86817_, int p_86818_, int p_86819_, float p_86820_) {
         RealmsMainScreen.this.drawInvitationPendingIcon(p_86817_, p_86818_, p_86819_, this.getX(), this.getY(), this.isHoveredOrFocused(), this.active);
      }
   }
