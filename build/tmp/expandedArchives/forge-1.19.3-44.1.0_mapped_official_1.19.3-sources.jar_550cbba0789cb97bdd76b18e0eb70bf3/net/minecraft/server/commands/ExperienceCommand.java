...
public class ExperienceCommand {
   ...
   static enum Type {
      POINTS("points", Player::giveExperiencePoints, (p_253473_, p_253474_) -> {
         if (p_253474_ >= p_253473_.getXpNeededForNextLevel()) {
            return false;
         } else {
            p_253473_.setExperiencePoints(p_253474_);
            return true;
         }
      }, (p_253472_) -> {
         return Mth.floor(p_253472_.experienceProgress * (float)p_253472_.getXpNeededForNextLevel());
      }),
      LEVELS("levels", ServerPlayer::giveExperienceLevels, (p_137360_, p_137361_) -> {
         p_137360_.setExperienceLevels(p_137361_);
         return true;
      }, (p_248135_) -> {
         return p_248135_.experienceLevel;
      });
