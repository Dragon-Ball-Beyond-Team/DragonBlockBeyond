...
public class ChunkMap extends ChunkStorage implements ChunkHolder.PlayerProvider {
   ...
   public void resendChunk(ChunkAccess p_262107_) {
      ChunkPos chunkpos = p_262107_.getPos();
      LevelChunk levelchunk;
      if (p_262107_ instanceof LevelChunk levelchunk1) {
      ...
      for(ServerPlayer serverplayer : this.getPlayers(chunkpos, false)) {
         if (mutableobject.getValue() == null) {
            mutableobject.setValue(new ClientboundLevelChunkWithLightPacket(levelchunk, this.lightEngine, (BitSet)null, (BitSet)null, true));
         }
