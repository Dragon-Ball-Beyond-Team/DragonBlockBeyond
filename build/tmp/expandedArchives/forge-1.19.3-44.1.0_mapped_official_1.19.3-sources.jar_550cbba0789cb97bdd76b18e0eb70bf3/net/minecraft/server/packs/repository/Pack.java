      ...
      try {
         ...
         label52: {
            ...
            try (PackResources packresources = p_250739_.open(p_250591_)) {
               ...
               pack$info = new Pack.Info(packmetadatasection.getDescription(), packmetadatasection.getPackFormat(PackType.SERVER_DATA), packmetadatasection.getPackFormat(PackType.CLIENT_RESOURCES), featureflagset, packresources.isHidden());
            }

            return pack$info;
         }

         return (Pack.Info)object;
