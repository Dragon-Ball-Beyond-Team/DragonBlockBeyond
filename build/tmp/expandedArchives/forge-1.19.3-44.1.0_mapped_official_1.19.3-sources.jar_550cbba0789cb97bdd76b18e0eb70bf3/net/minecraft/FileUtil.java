   ...
   public static DataResult<List<String>> decomposePath(String p_248866_) {
      ...
      if (i == -1) {
         ...
         switch (p_248866_) {
            ...
            case ".":
            case "..":
               dataresult = DataResult.error("Invalid path '" + p_248866_ + "'");
               break;
            default:
               dataresult = !isValidStrictPathSegment(p_248866_) ? DataResult.error("Invalid path '" + p_248866_ + "'") : DataResult.success(List.of(p_248866_));
         }
