...
public class PackMetadataGenerator implements DataProvider {
   ...
   public static PackMetadataGenerator forFeaturePack(PackOutput p_256281_, Component p_255661_) {
      return (new PackMetadataGenerator(p_256281_)).add(PackMetadataSection.TYPE, new PackMetadataSection(p_255661_, DetectedVersion.BUILT_IN.getPackVersion(PackType.DATA)));
   }
