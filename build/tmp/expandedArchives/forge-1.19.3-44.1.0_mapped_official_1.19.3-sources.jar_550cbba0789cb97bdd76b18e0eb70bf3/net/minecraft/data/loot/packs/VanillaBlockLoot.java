...
public class VanillaBlockLoot extends BlockLootSubProvider {
   ...
   protected void generate() {
      ...
      this.add(Blocks.ACACIA_DOOR, (p_251121_) -> {
         return this.createDoorTable(p_251121_);
      });
      this.add(Blocks.BIRCH_DOOR, (p_250041_) -> {
         return this.createDoorTable(p_250041_);
      });
      this.add(Blocks.DARK_OAK_DOOR, (p_251623_) -> {
         return this.createDoorTable(p_251623_);
      });
      this.add(Blocks.IRON_DOOR, (p_248614_) -> {
         return this.createDoorTable(p_248614_);
      });
      this.add(Blocks.JUNGLE_DOOR, (p_251181_) -> {
         return this.createDoorTable(p_251181_);
      });
      this.add(Blocks.OAK_DOOR, (p_250531_) -> {
         return this.createDoorTable(p_250531_);
      });
      this.add(Blocks.SPRUCE_DOOR, (p_249793_) -> {
         return this.createDoorTable(p_249793_);
      });
      this.add(Blocks.WARPED_DOOR, (p_249442_) -> {
         return this.createDoorTable(p_249442_);
      });
      this.add(Blocks.CRIMSON_DOOR, (p_250674_) -> {
         return this.createDoorTable(p_250674_);
      });
      this.add(Blocks.MANGROVE_DOOR, (p_251071_) -> {
         return this.createDoorTable(p_251071_);
      });
