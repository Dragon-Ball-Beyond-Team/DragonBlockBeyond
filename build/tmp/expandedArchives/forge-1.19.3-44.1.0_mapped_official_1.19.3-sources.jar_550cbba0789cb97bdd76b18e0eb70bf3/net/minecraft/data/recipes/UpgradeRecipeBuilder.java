...
public class UpgradeRecipeBuilder {
   ...
   public static UpgradeRecipeBuilder smithing(Ingredient p_249698_, Ingredient p_249725_, RecipeCategory p_248633_, Item p_249938_) {
      return new UpgradeRecipeBuilder(RecipeSerializer.SMITHING, p_249698_, p_249725_, p_248633_, p_249938_);
   }
   ...
   public void save(Consumer<FinishedRecipe> p_126396_, ResourceLocation p_126397_) {
      ...
      p_126396_.accept(new UpgradeRecipeBuilder.Result(p_126397_, this.type, this.base, this.addition, this.result, this.advancement, p_126397_.withPrefix("recipes/" + this.category.getFolderName() + "/")));
   }
