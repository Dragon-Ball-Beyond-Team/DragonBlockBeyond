...
public class OverworldBiomes {
   ...
   private static Biome baseJungle(HolderGetter<PlacedFeature> p_256470_, HolderGetter<ConfiguredWorldCarver<?>> p_256465_, float p_255630_, boolean p_256163_, boolean p_255882_, boolean p_255695_, MobSpawnSettings.Builder p_255859_) {
      ...
      return biome(Biome.Precipitation.RAIN, 0.95F, p_255630_, p_255859_, biomegenerationsettings$builder, music);
   }
   ...
   public static Biome meadow(HolderGetter<PlacedFeature> p_255697_, HolderGetter<ConfiguredWorldCarver<?>> p_256062_) {
      BiomeGenerationSettings.Builder biomegenerationsettings$builder = new BiomeGenerationSettings.Builder(p_255697_, p_256062_);
      MobSpawnSettings.Builder mobspawnsettings$builder = new MobSpawnSettings.Builder();
