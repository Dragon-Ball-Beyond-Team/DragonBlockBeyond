...
public class BiomeTagsProvider extends TagsProvider<Biome> {
   ...
   protected void addTags(HolderLookup.Provider p_256485_) {
      ...
      HolderGetter<Biome> holdergetter = p_256485_.lookupOrThrow(Registries.BIOME);
      ...
      MultiNoiseBiomeSource.Preset.OVERWORLD.possibleBiomes(holdergetter).forEach(tagappender1::add);
