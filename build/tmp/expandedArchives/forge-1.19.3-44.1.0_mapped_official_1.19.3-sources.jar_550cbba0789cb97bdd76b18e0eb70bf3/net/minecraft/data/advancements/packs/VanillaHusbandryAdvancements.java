...
public class VanillaHusbandryAdvancements implements AdvancementSubProvider {
   ...
   Advancement createRoot(Consumer<Advancement> p_262142_) {
      return Advancement.Builder.advancement().display(Blocks.HAY_BLOCK, Component.translatable("advancements.husbandry.root.title"), Component.translatable("advancements.husbandry.root.description"), new ResourceLocation("textures/gui/advancements/backgrounds/husbandry.png"), FrameType.TASK, false, false, false).addCriterion("consumed_item", ConsumeItemTrigger.TriggerInstance.usedItem()).save(p_262142_, "husbandry/root");
   }

   Advancement createBreedAnAnimalAdvancement(Advancement p_262045_, Consumer<Advancement> p_262162_) {
      return Advancement.Builder.advancement().parent(p_262045_).display(Items.WHEAT, Component.translatable("advancements.husbandry.breed_an_animal.title"), Component.translatable("advancements.husbandry.breed_an_animal.description"), (ResourceLocation)null, FrameType.TASK, true, true, false).requirements(RequirementsStrategy.OR).addCriterion("bred", BredAnimalsTrigger.TriggerInstance.bredAnimals()).save(p_262162_, "husbandry/breed_an_animal");
   }

   Advancement createBreedAllAnimalsAdvancement(Advancement p_261727_, Consumer<Advancement> p_262006_) {
      return this.addBreedable(Advancement.Builder.advancement()).parent(p_261727_).display(Items.GOLDEN_CARROT, Component.translatable("advancements.husbandry.breed_all_animals.title"), Component.translatable("advancements.husbandry.breed_all_animals.description"), (ResourceLocation)null, FrameType.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(100)).save(p_262006_, "husbandry/bred_all_animals");
   }
   ...
   Advancement.Builder addBreedable(Advancement.Builder p_250185_) {
      for(EntityType<?> entitytype : this.getBreedableAnimals()) {
         p_250185_.addCriterion(EntityType.getKey(entitytype).toString(), BredAnimalsTrigger.TriggerInstance.bredAnimals(EntityPredicate.Builder.entity().of(entitytype)));
      }

      for(EntityType<?> entitytype1 : this.getIndirectlyBreedableAnimals()) {
         p_250185_.addCriterion(EntityType.getKey(entitytype1).toString(), BredAnimalsTrigger.TriggerInstance.bredAnimals(EntityPredicate.Builder.entity().of(entitytype1).build(), EntityPredicate.Builder.entity().of(entitytype1).build(), EntityPredicate.ANY));
      }
