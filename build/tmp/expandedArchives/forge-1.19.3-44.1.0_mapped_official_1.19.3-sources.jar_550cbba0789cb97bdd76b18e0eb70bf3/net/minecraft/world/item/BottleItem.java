...
public class BottleItem extends Item {
   ...
   public InteractionResultHolder<ItemStack> use(Level p_40656_, Player p_40657_, InteractionHand p_40658_) {
      List<AreaEffectCloud> list = p_40656_.getEntitiesOfClass(AreaEffectCloud.class, p_40657_.getBoundingBox().inflate(2.0D), (p_253594_) -> {
         return p_253594_ != null && p_253594_.isAlive() && p_253594_.getOwner() instanceof EnderDragon;
      });
