   ...
   public static BehaviorControl<Piglin> create() {
      return BehaviorBuilder.create((p_259197_) -> {
         return p_259197_.group(p_259197_.absent(MemoryModuleType.ADMIRING_ITEM)).apply(p_259197_, (p_259512_) -> {
            return (p_259681_, p_260321_, p_259451_) -> {
               if (!p_260321_.getOffhandItem().isEmpty() && !p_260321_.getOffhandItem().canPerformAction(net.minecraftforge.common.ToolActions.SHIELD_BLOCK)) {
                  PiglinAi.stopHoldingOffHandItem(p_260321_, true);
                  return true;
               } else {
                  return false;
               }
