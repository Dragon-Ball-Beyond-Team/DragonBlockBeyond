...
public class Panda extends Animal {
   ...
   static final Predicate<ItemEntity> PANDA_ITEMS = (p_253568_) -> {
      ItemStack itemstack = p_253568_.getItem();
      return (itemstack.is(Blocks.BAMBOO.asItem()) || itemstack.is(Blocks.CAKE.asItem())) && p_253568_.isAlive() && !p_253568_.hasPickUpDelay();
   };
