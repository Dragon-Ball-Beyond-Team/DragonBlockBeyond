...
public class GoatAi {
   ...
   private static final TargetingConditions RAM_TARGET_CONDITIONS = TargetingConditions.forCombat().selector((p_253570_) -> {
      return !p_253570_.getType().equals(EntityType.GOAT) && p_253570_.level.getWorldBorder().isWithinBounds(p_253570_.getBoundingBox());
   });
   ...
   private static void initRamActivity(Brain<Goat> p_149466_) {
      ...
      }, RAM_TARGET_CONDITIONS, 3.0F, (p_248373_) -> {
         return p_248373_.isBaby() ? 1.0D : 2.5D;
      }, (p_149468_) -> {
