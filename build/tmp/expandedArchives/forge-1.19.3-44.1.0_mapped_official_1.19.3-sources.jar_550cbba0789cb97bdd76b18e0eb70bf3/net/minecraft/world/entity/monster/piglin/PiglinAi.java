...
public class PiglinAi {
   ...
   protected static void wasHurtBy(Piglin p_34838_, LivingEntity p_34839_) {
      if (!(p_34839_ instanceof Piglin)) {
         ...
         getAvoidTarget(p_34838_).ifPresent((p_248390_) -> {
            if (p_248390_.getType() != p_34839_.getType()) {
   ...
   protected static void broadcastAngerTarget(AbstractPiglin p_34896_, LivingEntity p_34897_) {
      getAdultPiglins(p_34896_).forEach((p_248393_) -> {
         if (p_34897_.getType() != EntityType.HOGLIN || p_248393_.canHunt() && ((Hoglin)p_34897_).canBeHunted()) {
            setAngerTargetIfCloserThanCurrent(p_248393_, p_34897_);
         }
      });
   }
