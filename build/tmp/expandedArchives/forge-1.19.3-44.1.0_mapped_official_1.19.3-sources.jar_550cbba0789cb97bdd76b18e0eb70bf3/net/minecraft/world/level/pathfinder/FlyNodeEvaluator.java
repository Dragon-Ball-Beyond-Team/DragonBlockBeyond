...
public class FlyNodeEvaluator extends WalkNodeEvaluator {
   ...
   public Node getStart() {
      ...
      BlockPos blockpos1 = new BlockPos(this.mob.getX(), (double)i, this.mob.getZ());
   ...
   private Iterable<BlockPos> iteratePathfindingStartNodeCandidatePositions(Mob p_263108_) {
      ...
      if (!flag) {
         return List.of(new BlockPos(aabb.minX, (double)p_263108_.getBlockY(), aabb.minZ), new BlockPos(aabb.minX, (double)p_263108_.getBlockY(), aabb.maxZ), new BlockPos(aabb.maxX, (double)p_263108_.getBlockY(), aabb.minZ), new BlockPos(aabb.maxX, (double)p_263108_.getBlockY(), aabb.maxZ));
      } else {
