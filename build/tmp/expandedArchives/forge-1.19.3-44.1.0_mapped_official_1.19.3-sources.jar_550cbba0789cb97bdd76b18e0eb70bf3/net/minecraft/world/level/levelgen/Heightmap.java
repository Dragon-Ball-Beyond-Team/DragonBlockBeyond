...
public class Heightmap {
   ...
   public static enum Types implements StringRepresentable {
      ...
      MOTION_BLOCKING("MOTION_BLOCKING", Heightmap.Usage.CLIENT, (p_248474_) -> {
         return p_248474_.getMaterial().blocksMotion() || !p_248474_.getFluidState().isEmpty();
      }),
      MOTION_BLOCKING_NO_LEAVES("MOTION_BLOCKING_NO_LEAVES", Heightmap.Usage.LIVE_WORLD, (p_248475_) -> {
         return (p_248475_.getMaterial().blocksMotion() || !p_248475_.getFluidState().isEmpty()) && !(p_248475_.getBlock() instanceof LeavesBlock);
      });
