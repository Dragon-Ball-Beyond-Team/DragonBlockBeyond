...
public class PressurePlateBlock extends BasePressurePlateBlock {
   ...
   public PressurePlateBlock(PressurePlateBlock.Sensitivity p_250675_, BlockBehaviour.Properties p_249590_, SoundEvent p_249532_, SoundEvent p_250629_) {
      super(p_249590_);
      this.registerDefaultState(this.stateDefinition.any().setValue(POWERED, Boolean.valueOf(false)));
      this.sensitivity = p_250675_;
      this.soundOff = p_249532_;
      this.soundOn = p_250629_;
   }
   ...
   protected void playOnSound(LevelAccessor p_55256_, BlockPos p_55257_) {
      p_55256_.playSound((Player)null, p_55257_, this.soundOn, SoundSource.BLOCKS);
   }

   protected void playOffSound(LevelAccessor p_55267_, BlockPos p_55268_) {
      p_55267_.playSound((Player)null, p_55268_, this.soundOff, SoundSource.BLOCKS);
   }
