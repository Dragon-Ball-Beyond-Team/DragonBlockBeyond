...
public class MultiNoiseBiomeSource extends BiomeSource {
   ...
   public static class Preset {
      ...
      public static final MultiNoiseBiomeSource.Preset NETHER = new MultiNoiseBiomeSource.Preset(new ResourceLocation("nether"), (p_255954_) -> {
         return new Climate.ParameterList<>(ImmutableList.of(Pair.of(Climate.parameters(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F), p_255954_.getOrThrow(Biomes.NETHER_WASTES)), Pair.of(Climate.parameters(0.0F, -0.5F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F), p_255954_.getOrThrow(Biomes.SOUL_SAND_VALLEY)), Pair.of(Climate.parameters(0.4F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F), p_255954_.getOrThrow(Biomes.CRIMSON_FOREST)), Pair.of(Climate.parameters(0.0F, 0.5F, 0.0F, 0.0F, 0.0F, 0.0F, 0.375F), p_255954_.getOrThrow(Biomes.WARPED_FOREST)), Pair.of(Climate.parameters(-0.5F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.175F), p_255954_.getOrThrow(Biomes.BASALT_DELTAS))));
      });
      public static final MultiNoiseBiomeSource.Preset OVERWORLD = new MultiNoiseBiomeSource.Preset(new ResourceLocation("overworld"), (p_256611_) -> {
         ImmutableList.Builder<Pair<Climate.ParameterPoint, Holder<Biome>>> builder = ImmutableList.builder();
         (new OverworldBiomeBuilder()).addBiomes((p_204279_) -> {
            builder.add(p_204279_.mapSecond(p_256611_::getOrThrow));
         });
      ...
      public Preset(ResourceLocation p_187090_, Function<HolderGetter<Biome>, Climate.ParameterList<Holder<Biome>>> p_187091_) {
         this.name = p_187090_;
      ...
      public MultiNoiseBiomeSource biomeSource(HolderGetter<Biome> p_256280_, boolean p_256343_) {
         return this.biomeSource(new MultiNoiseBiomeSource.PresetInstance(this, p_256280_), p_256343_);
      }

      public MultiNoiseBiomeSource biomeSource(HolderGetter<Biome> p_255641_) {
         return this.biomeSource(p_255641_, true);
      }

      public Stream<ResourceKey<Biome>> possibleBiomes(HolderGetter<Biome> p_256671_) {
         return this.biomeSource(p_256671_).possibleBiomes().stream().flatMap((p_220659_) -> {
   ...
   static record PresetInstance(MultiNoiseBiomeSource.Preset preset, HolderGetter<Biome> biomes) {
      public static final MapCodec<MultiNoiseBiomeSource.PresetInstance> CODEC = RecordCodecBuilder.mapCodec((p_258969_) -> {
         return p_258969_.group(ResourceLocation.CODEC.flatXmap((p_151869_) -> {
         ...
         }).fieldOf("preset").stable().forGetter(MultiNoiseBiomeSource.PresetInstance::preset), RegistryOps.retrieveGetter(Registries.BIOME)).apply(p_258969_, p_258969_.stable(MultiNoiseBiomeSource.PresetInstance::new));
      });
