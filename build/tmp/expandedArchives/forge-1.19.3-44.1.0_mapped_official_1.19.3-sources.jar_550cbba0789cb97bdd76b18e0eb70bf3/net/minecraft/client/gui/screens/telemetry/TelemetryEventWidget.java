...
public class TelemetryEventWidget extends AbstractScrollWidget {
   ...
   protected void renderContents(PoseStack p_261905_, int p_262043_, int p_261724_, float p_262063_) {
      ...
      this.content.container().render(p_261905_, p_262043_, p_261724_, p_262063_);
      p_261905_.popPose();
   }
   ...
   static class ContentBuilder {
      ...
      public void addLine(Font p_261894_, Component p_261816_, int p_261721_) {
         this.helper.addChild(MultiLineTextWidget.create(this.width, p_261894_, p_261816_), this.helper.newCellSettings().paddingBottom(p_261721_));
         this.narration.append(p_261816_).append("\n");
      }

      public void addHeader(Font p_261496_, Component p_261670_) {
         this.helper.addChild(MultiLineTextWidget.createCentered(this.width - 64, p_261496_, p_261670_), this.alignHeader);
