...
public class RecipeBookTabButton extends StateSwitchingButton {
   ...
   public void renderButton(PoseStack p_100457_, int p_100458_, int p_100459_, float p_100460_) {
      ...
      this.blit(p_100457_, k, this.getY(), i, j, this.width, this.height);
   ...
   private void renderIcon(ItemRenderer p_100454_) {
      ...
      if (list.size() == 1) {
         p_100454_.renderAndDecorateFakeItem(list.get(0), this.getX() + 9 + i, this.getY() + 5);
      } else if (list.size() == 2) {
         p_100454_.renderAndDecorateFakeItem(list.get(0), this.getX() + 3 + i, this.getY() + 5);
         p_100454_.renderAndDecorateFakeItem(list.get(1), this.getX() + 14 + i, this.getY() + 5);
      }
