...
public class ConfirmExperimentalFeaturesScreen extends Screen {
   ...
   public void render(PoseStack p_251344_, int p_248682_, int p_251917_, float p_249477_) {
      ...
      drawCenteredString(p_251344_, this.font, this.title, this.width / 2, this.titleTop(), 16777215);
      this.multilineMessage.renderCentered(p_251344_, this.width / 2, this.titleTop() + 20);
