...
public abstract class GuiComponent {
   ...
   private static void innerFill(Matrix4f p_254518_, int p_93107_, int p_93108_, int p_93109_, int p_93110_, int p_93111_) {
      ...
      bufferbuilder.vertex(p_254518_, (float)p_93107_, (float)p_93110_, 0.0F).color(f, f1, f2, f3).endVertex();
      bufferbuilder.vertex(p_254518_, (float)p_93109_, (float)p_93110_, 0.0F).color(f, f1, f2, f3).endVertex();
      bufferbuilder.vertex(p_254518_, (float)p_93109_, (float)p_93108_, 0.0F).color(f, f1, f2, f3).endVertex();
      bufferbuilder.vertex(p_254518_, (float)p_93107_, (float)p_93108_, 0.0F).color(f, f1, f2, f3).endVertex();
