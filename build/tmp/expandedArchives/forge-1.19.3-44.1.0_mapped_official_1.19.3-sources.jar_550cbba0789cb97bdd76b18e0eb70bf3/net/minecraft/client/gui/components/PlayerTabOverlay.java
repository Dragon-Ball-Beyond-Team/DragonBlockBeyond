   ...
   private void renderTablistHearts(int p_250075_, int p_249542_, int p_252111_, UUID p_251726_, PoseStack p_251133_, int p_249723_) {
      ...
      if (i > 0) {
         ...
         if (k <= 3) {
            ...
            for(int l = i; l < j; ++l) {
               this.blit(p_251133_, p_249542_ + l * k, p_250075_, flag ? 25 : 16, 0, 9, 9);
            }

            for(int j1 = 0; j1 < i; ++j1) {
               this.blit(p_251133_, p_249542_ + j1 * k, p_250075_, flag ? 25 : 16, 0, 9, 9);
               if (flag) {
                  if (j1 * 2 + 1 < playertaboverlay$healthstate.displayedValue()) {
                     this.blit(p_251133_, p_249542_ + j1 * k, p_250075_, 70, 0, 9, 9);
                  }

                  if (j1 * 2 + 1 == playertaboverlay$healthstate.displayedValue()) {
                     this.blit(p_251133_, p_249542_ + j1 * k, p_250075_, 79, 0, 9, 9);
                  }
               }

               if (j1 * 2 + 1 < p_249723_) {
                  this.blit(p_251133_, p_249542_ + j1 * k, p_250075_, j1 >= 10 ? 160 : 52, 0, 9, 9);
               }

               if (j1 * 2 + 1 == p_249723_) {
                  this.blit(p_251133_, p_249542_ + j1 * k, p_250075_, j1 >= 10 ? 169 : 61, 0, 9, 9);
               }
            }
