...
public class PackSelectionScreen extends Screen {
   ...
   public PackSelectionScreen(Screen p_250119_, PackRepository p_249296_, Consumer<PackRepository> p_250932_, Path p_251292_, Component p_251319_) {
      super(p_251319_);
      this.lastScreen = p_250119_;
      this.model = new PackSelectionModel(this::populateLists, this::getPackIcon, p_249296_, p_250932_);
      this.packDir = p_251292_;
      this.watcher = PackSelectionScreen.Watcher.create(p_251292_);
   }
