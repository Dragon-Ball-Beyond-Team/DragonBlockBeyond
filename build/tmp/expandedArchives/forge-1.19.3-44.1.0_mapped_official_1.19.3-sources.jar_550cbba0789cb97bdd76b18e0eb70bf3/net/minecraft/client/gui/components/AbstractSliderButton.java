...
public abstract class AbstractSliderButton extends AbstractWidget {
   ...
   protected void renderBg(PoseStack p_93600_, Minecraft p_93601_, int p_93602_, int p_93603_) {
      ...
      this.blit(p_93600_, this.getX() + (int)(this.value * (double)(this.width - 8)), this.getY(), 0, 46 + i, 4, 20);
      this.blit(p_93600_, this.getX() + (int)(this.value * (double)(this.width - 8)) + 4, this.getY(), 196, 46 + i, 4, 20);
   }
