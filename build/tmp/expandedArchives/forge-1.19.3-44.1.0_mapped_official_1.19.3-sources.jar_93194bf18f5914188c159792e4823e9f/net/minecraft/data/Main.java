...
public class Main {
   ...
   public static DataGenerator createStandardGenerator(Path p_236680_, Collection<Path> p_236681_, boolean p_236682_, boolean p_236683_, boolean p_236684_, boolean p_236685_, boolean p_236686_, WorldVersion p_236687_, boolean p_236688_) {
      ...
      datagenerator$packgenerator1 = datagenerator.getVanillaPack(p_236683_);
      datagenerator$packgenerator1.addProvider(bindRegistries(RegistriesDatapackGenerator::new, completablefuture));
      datagenerator$packgenerator1.addProvider(bindRegistries(VanillaAdvancementProvider::create, completablefuture));
      datagenerator$packgenerator1.addProvider(VanillaLootTableProvider::create);
      datagenerator$packgenerator1.addProvider(VanillaRecipeProvider::new);
      TagsProvider<Block> tagsprovider = datagenerator$packgenerator1.addProvider(bindRegistries(VanillaBlockTagsProvider::new, completablefuture));
      datagenerator$packgenerator1.addProvider((p_255482_) -> {
         return new VanillaItemTagsProvider(p_255482_, completablefuture, tagsprovider);
      });
      datagenerator$packgenerator1.addProvider(bindRegistries(BannerPatternTagsProvider::new, completablefuture));
      datagenerator$packgenerator1.addProvider(bindRegistries(BiomeTagsProvider::new, completablefuture));
      datagenerator$packgenerator1.addProvider(bindRegistries(CatVariantTagsProvider::new, completablefuture));
      datagenerator$packgenerator1.addProvider(bindRegistries(EntityTypeTagsProvider::new, completablefuture));
      datagenerator$packgenerator1.addProvider(bindRegistries(FlatLevelGeneratorPresetTagsProvider::new, completablefuture));
      datagenerator$packgenerator1.addProvider(bindRegistries(FluidTagsProvider::new, completablefuture));
      datagenerator$packgenerator1.addProvider(bindRegistries(GameEventTagsProvider::new, completablefuture));
      datagenerator$packgenerator1.addProvider(bindRegistries(InstrumentTagsProvider::new, completablefuture));
      datagenerator$packgenerator1.addProvider(bindRegistries(PaintingVariantTagsProvider::new, completablefuture));
      datagenerator$packgenerator1.addProvider(bindRegistries(PoiTypeTagsProvider::new, completablefuture));
      datagenerator$packgenerator1.addProvider(bindRegistries(StructureTagsProvider::new, completablefuture));
      datagenerator$packgenerator1.addProvider(bindRegistries(WorldPresetTagsProvider::new, completablefuture));
      datagenerator$packgenerator1 = datagenerator.getVanillaPack(p_236684_);
      datagenerator$packgenerator1.addProvider((p_253386_) -> {
         return new NbtToSnbt(p_253386_, p_236681_);
      });
      datagenerator$packgenerator1 = datagenerator.getVanillaPack(p_236685_);
      datagenerator$packgenerator1.addProvider(bindRegistries(BiomeParametersDumpReport::new, completablefuture));
      datagenerator$packgenerator1.addProvider(BlockListReport::new);
      datagenerator$packgenerator1.addProvider(bindRegistries(CommandsReport::new, completablefuture));
      datagenerator$packgenerator1.addProvider(RegistryDumpReport::new);
      datagenerator$packgenerator1 = datagenerator.getBuiltinDatapack(p_236683_, "bundle");
      datagenerator$packgenerator1.addProvider(BundleRecipeProvider::new);
      datagenerator$packgenerator1.addProvider((p_253392_) -> {
      ...
      datagenerator$packgenerator1 = datagenerator.getBuiltinDatapack(p_236683_, "update_1_20");
      datagenerator$packgenerator1.addProvider(UpdateOneTwentyRecipeProvider::new);
      TagsProvider<Block> tagsprovider2 = datagenerator$packgenerator1.addProvider(bindRegistries(UpdateOneTwentyBlockTagsProvider::new, completablefuture));
      datagenerator$packgenerator1.addProvider((p_255479_) -> {
         return new UpdateOneTwentyItemTagsProvider(p_255479_, completablefuture, tagsprovider2);
      });
      datagenerator$packgenerator1.addProvider(UpdateOneTwentyLootTableProvider::create);
      datagenerator$packgenerator1.addProvider(bindRegistries(UpdateOneTwentyVanillaAdvancementProvider::create, completablefuture));
      datagenerator$packgenerator1.addProvider((p_253389_) -> {
