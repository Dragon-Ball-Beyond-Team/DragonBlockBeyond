...
public class ShapedRecipeBuilder extends CraftingRecipeBuilder implements RecipeBuilder {
   ...
   public void save(Consumer<FinishedRecipe> p_126141_, ResourceLocation p_126142_) {
      ...
      p_126141_.accept(new ShapedRecipeBuilder.Result(p_126142_, this.result, this.count, this.group == null ? "" : this.group, determineBookCategory(this.category), this.rows, this.key, this.advancement, p_126142_.withPrefix("recipes/" + this.category.getFolderName() + "/")));
   }
   ...
   public static class Result extends CraftingRecipeBuilder.CraftingResult {
      ...
      public Result(ResourceLocation p_249291_, Item p_250067_, int p_249914_, String p_250777_, CraftingBookCategory p_251016_, List<String> p_251191_, Map<Character, Ingredient> p_249552_, Advancement.Builder p_250121_, ResourceLocation p_250246_) {
         super(p_251016_);
         this.id = p_249291_;
         this.result = p_250067_;
         this.count = p_249914_;
         this.group = p_250777_;
         this.pattern = p_251191_;
         this.key = p_249552_;
         this.advancement = p_250121_;
         this.advancementId = p_250246_;
      }
