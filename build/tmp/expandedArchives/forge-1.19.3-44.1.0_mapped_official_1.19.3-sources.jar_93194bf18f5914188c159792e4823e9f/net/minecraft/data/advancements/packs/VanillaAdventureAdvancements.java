...
public class VanillaAdventureAdvancements implements AdvancementSubProvider {
   ...
   public void generate(HolderLookup.Provider p_255887_, Consumer<Advancement> p_256428_) {
      ...
      HolderGetter<Biome> holdergetter = p_255887_.lookupOrThrow(Registries.BIOME);
      addBiomes(Advancement.Builder.advancement(), MultiNoiseBiomeSource.Preset.OVERWORLD.possibleBiomes(holdergetter).toList()).parent(advancement1).display(Items.DIAMOND_BOOTS, Component.translatable("advancements.adventure.adventuring_time.title"), Component.translatable("advancements.adventure.adventuring_time.description"), (ResourceLocation)null, FrameType.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(500)).save(p_256428_, "adventure/adventuring_time");
