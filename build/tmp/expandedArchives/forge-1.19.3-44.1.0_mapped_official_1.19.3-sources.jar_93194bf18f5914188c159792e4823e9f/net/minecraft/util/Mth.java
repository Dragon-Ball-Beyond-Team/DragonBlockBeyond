...
public class Mth {
   ...
   public static float truncate(float p_252058_, float p_249878_) {
      float f = (float)Math.pow(10.0D, (double)p_249878_);
      return (float)((int)(p_252058_ * f)) / f;
   }
   ...
   public static boolean isDivisionInteger(int p_250106_, int p_251206_) {
      return p_250106_ / p_251206_ * p_251206_ == p_250106_;
   }
