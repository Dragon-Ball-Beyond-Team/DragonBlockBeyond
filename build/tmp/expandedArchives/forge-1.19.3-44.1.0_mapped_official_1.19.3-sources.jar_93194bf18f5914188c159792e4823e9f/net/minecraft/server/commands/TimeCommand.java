...
public class TimeCommand {
   public static void register(CommandDispatcher<CommandSourceStack> p_139072_) {
      ...
      })).then(Commands.literal("gametime").executes((p_248186_) -> {
         return queryTime(p_248186_.getSource(), (int)(p_248186_.getSource().getLevel().getGameTime() % 2147483647L));
      })).then(Commands.literal("day").executes((p_248185_) -> {
         return queryTime(p_248185_.getSource(), (int)(p_248185_.getSource().getLevel().getDayTime() / 24000L % 2147483647L));
      }))));
   }
