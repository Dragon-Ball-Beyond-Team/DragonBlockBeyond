...
public class WhitelistCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> p_139202_) {
      p_139202_.register(Commands.literal("whitelist").requires((p_139234_) -> {
         ...
         return SharedSuggestionProvider.suggest(playerlist.getPlayers().stream().filter((p_253484_) -> {
            return !playerlist.getWhiteList().isWhiteListed(p_253484_.getGameProfile());
         }).map((p_253482_) -> {
            return p_253482_.getGameProfile().getName();
         }), p_139217_);
      }).executes((p_139224_) -> {
