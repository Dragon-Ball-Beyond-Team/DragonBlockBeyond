...
public class JoinMultiplayerScreen extends Screen {
   ...
   protected void init() {
      ...
      this.addRenderableWidget(Button.builder(Component.translatable("selectServer.direct"), (p_99724_) -> {
      ...
      this.addRenderableWidget(Button.builder(Component.translatable("selectServer.add"), (p_99720_) -> {
         this.editingServer = new ServerData(I18n.get("selectServer.defaultName"), "", false);
      ...
      this.addRenderableWidget(Button.builder(Component.translatable("selectServer.refresh"), (p_99706_) -> {
         this.refreshServerList();
      }).bounds(this.width / 2 + 4, this.height - 28, 70, 20).build());
      this.addRenderableWidget(Button.builder(CommonComponents.GUI_CANCEL, (p_99699_) -> {
