...
public class Gui extends GuiComponent {
      ...
      if (options.getCameraType().isFirstPerson()) {
         if (this.minecraft.gameMode.getPlayerMode() != GameType.SPECTATOR || this.canRenderCrosshairForSpectator(this.minecraft.hitResult)) {
            if (options.renderDebug && !options.hideGui && !this.minecraft.player.isReducedDebugInfo() && !options.reducedDebugInfo().get()) {
               ...
               posestack.pushPose();
               posestack.translate((float)(this.screenWidth / 2), (float)(this.screenHeight / 2), (float)this.getBlitOffset());
   ...
   public void renderJumpMeter(PlayerRideableJumping p_250242_, PoseStack p_250216_, int p_248942_) {
      ...
      this.blit(p_250216_, p_248942_, k, 0, 84, 182, 5);
      if (p_250242_.getJumpCooldown() > 0) {
         this.blit(p_250216_, p_248942_, k, 0, 74, 182, 5);
      } else if (j > 0) {
         this.blit(p_250216_, p_248942_, k, 0, 89, j, 5);
      }
   ...
   private void renderSlot(int p_168678_, int p_168679_, float p_168680_, Player p_168681_, ItemStack p_168682_, int p_168683_) {
      if (!p_168682_.isEmpty()) {
         ...
         if (f > 0.0F) {
            ...
            posestack.pushPose();
            posestack.translate((float)(p_168678_ + 8), (float)(p_168679_ + 12), 0.0F);
