...
public class ChatLog {
   ...
   public static Codec<ChatLog> codec(int p_253922_) {
      return Codec.list(LoggedChatEvent.CODEC).comapFlatMap((p_254191_) -> {
         return p_254191_.size() > p_253922_ ? DataResult.error("Expected: a buffer of size less than or equal to " + p_253922_ + " but: " + p_254191_.size() + " is greater than " + p_253922_) : DataResult.success(new ChatLog(p_253922_, p_254191_));
