...
public class TelemetryEventType {
   ...
   public static final Codec<TelemetryEventType> CODEC = Codec.STRING.comapFlatMap((p_262081_) -> {
      TelemetryEventType telemetryeventtype = REGISTRY.get(p_262081_);
      return telemetryeventtype != null ? DataResult.success(telemetryeventtype) : DataResult.error("No TelemetryEventType with key: '" + p_262081_ + "'");
