   ...
   public void tick() {
      ...
      this.moodSettings.ifPresent((p_119650_) -> {
         ...
         if (this.moodiness >= 1.0F) {
            ...
            SimpleSoundInstance simplesoundinstance = SimpleSoundInstance.forAmbientMood(p_119650_.getSoundEvent().value(), this.random, this.player.getX() + d3 / d6 * d7, this.player.getEyeY() + d4 / d6 * d7, this.player.getZ() + d5 / d6 * d7);
