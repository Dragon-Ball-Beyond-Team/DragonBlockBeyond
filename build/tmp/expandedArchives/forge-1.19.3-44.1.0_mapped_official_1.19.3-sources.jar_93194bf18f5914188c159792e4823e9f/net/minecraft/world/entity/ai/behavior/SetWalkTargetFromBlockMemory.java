      ...
      return BehaviorBuilder.create((p_258717_) -> {
         return p_258717_.group(p_258717_.registered(MemoryModuleType.CANT_REACH_WALK_TARGET_SINCE), p_258717_.absent(MemoryModuleType.WALK_TARGET), p_258717_.present(p_259685_)).apply(p_258717_, (p_258709_, p_258710_, p_258711_) -> {
            return (p_258727_, p_258728_, p_258729_) -> {
               ...
               if (globalpos.dimension() == p_258727_.dimension() && (!optional.isPresent() || p_258727_.getGameTime() - optional.get() <= (long)p_259504_)) {
                  if (globalpos.pos().distManhattan(p_258728_.blockPosition()) > p_260360_) {
                     Vec3 vec3 = null;
                     int i = 0;
                     int j = 1000;

                     while(vec3 == null || (new BlockPos(vec3)).distManhattan(p_258728_.blockPosition()) > p_260360_) {
                        vec3 = DefaultRandomPos.getPosTowards(p_258728_, 15, 7, Vec3.atBottomCenterOf(globalpos.pos()), (double)((float)Math.PI / 2F));
                        ++i;
                        if (i == 1000) {
                           p_258728_.releasePoi(p_259685_);
                           p_258711_.erase();
                  ...
                  } else if (globalpos.pos().distManhattan(p_258728_.blockPosition()) > p_259530_) {
