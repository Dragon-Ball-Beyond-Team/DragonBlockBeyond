...
public class WanderingTrader extends AbstractVillager {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(0, new UseItemGoal<>(this, PotionUtils.setPotion(new ItemStack(Items.POTION), Potions.INVISIBILITY), SoundEvents.WANDERING_TRADER_DISAPPEARED, (p_253583_) -> {
         return this.level.isNight() && !p_253583_.isInvisible();
      }));
      this.goalSelector.addGoal(0, new UseItemGoal<>(this, new ItemStack(Items.MILK_BUCKET), SoundEvents.WANDERING_TRADER_REAPPEARED, (p_253584_) -> {
         return this.level.isDay() && p_253584_.isInvisible();
      }));
