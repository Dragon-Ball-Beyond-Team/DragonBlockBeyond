...
public class Pufferfish extends AbstractFish {
   ...
   int inflateCounter;
   int deflateTimer;
   private static final Predicate<LivingEntity> SCARY_MOB = (p_248369_) -> {
      if (p_248369_ instanceof Player && ((Player)p_248369_).isCreative()) {
         return false;
      } else {
         return p_248369_.getType() == EntityType.AXOLOTL || p_248369_.getMobType() != MobType.WATER;
      }
   };
