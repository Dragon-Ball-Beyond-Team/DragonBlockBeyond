...
public abstract class Raider extends PatrollingMonster {
   ...
   static final Predicate<ItemEntity> ALLOWED_ITEMS = (p_253590_) -> {
      return !p_253590_.hasPickUpDelay() && p_253590_.isAlive() && ItemStack.matches(p_253590_.getItem(), Raid.getLeaderBannerInstance());
   };
   @Nullable
   protected Raid raid;
   private int wave;
