...
public class WardenEntitySensor extends NearestLivingEntitySensor<Warden> {
   ...
   protected void doTick(ServerLevel p_217833_, Warden p_217834_) {
      ...
      getClosest(p_217834_, (p_248338_) -> {
         return p_248338_.getType() == EntityType.PLAYER;
      }).or(() -> {
         return getClosest(p_217834_, (p_248337_) -> {
            return p_248337_.getType() != EntityType.PLAYER;
         });
