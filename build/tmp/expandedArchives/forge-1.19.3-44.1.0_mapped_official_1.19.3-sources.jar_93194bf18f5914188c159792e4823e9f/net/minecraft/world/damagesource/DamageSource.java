...
public class DamageSource {
   ...
   public static DamageSource fallingBlock(Entity p_254272_) {
      return (new EntityDamageSource("fallingBlock", p_254272_)).damageHelmet();
   }

   public static DamageSource anvil(Entity p_254373_) {
      return (new EntityDamageSource("anvil", p_254373_)).damageHelmet();
   }

   public static DamageSource fallingStalactite(Entity p_253863_) {
      return (new EntityDamageSource("fallingStalactite", p_253863_)).damageHelmet();
   }
   ...
   public static DamageSource explosion(@Nullable Explosion p_19359_) {
      return p_19359_ != null ? explosion(p_19359_.getDirectSourceEntity(), p_19359_.getIndirectSourceEntity()) : explosion((Entity)null, (Entity)null);
   }

   public static DamageSource explosion(@Nullable Entity p_253770_, @Nullable Entity p_253659_) {
      if (p_253659_ != null && p_253770_ != null) {
         return (new IndirectEntityDamageSource("explosion.player", p_253770_, p_253659_)).setScalesWithDifficulty().setExplosion();
      } else {
         return p_253770_ != null ? (new EntityDamageSource("explosion", p_253770_)).setScalesWithDifficulty().setExplosion() : (new DamageSource("explosion")).setScalesWithDifficulty().setExplosion();
      }
   }
   ...
   public static DamageSource badRespawnPointExplosion(Vec3 p_253714_) {
      return new BadRespawnPointDamage(p_253714_);
   }
