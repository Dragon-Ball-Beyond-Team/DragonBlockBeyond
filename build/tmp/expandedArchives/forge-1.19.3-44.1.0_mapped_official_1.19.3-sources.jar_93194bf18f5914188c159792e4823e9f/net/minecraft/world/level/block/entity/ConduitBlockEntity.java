...
public class ConduitBlockEntity extends BlockEntity {
   ...
   private static void updateDestroyTarget(Level p_155409_, BlockPos p_155410_, BlockState p_155411_, List<BlockPos> p_155412_, ConduitBlockEntity p_155413_) {
      ...
      if (i < 42) {
         ...
         List<LivingEntity> list = p_155409_.getEntitiesOfClass(LivingEntity.class, getDestroyRangeAABB(p_155410_), (p_253604_) -> {
            return p_253604_ instanceof Enemy && p_253604_.isInWaterOrRain();
         });
         if (!list.isEmpty()) {
   ...
   private static LivingEntity findDestroyTarget(Level p_155425_, BlockPos p_155426_, UUID p_155427_) {
      List<LivingEntity> list = p_155425_.getEntitiesOfClass(LivingEntity.class, getDestroyRangeAABB(p_155426_), (p_253606_) -> {
         return p_253606_.getUUID().equals(p_155427_);
      });
