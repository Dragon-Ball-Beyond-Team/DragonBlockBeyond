...
public class MobSpawnSettings {
   ...
   public static class SpawnerData extends WeightedEntry.IntrusiveBase {
      public static final Codec<MobSpawnSettings.SpawnerData> CODEC = RecordCodecBuilder.create((p_258968_) -> {
         return p_258968_.group(BuiltInRegistries.ENTITY_TYPE.byNameCodec().fieldOf("type").forGetter((p_151826_) -> {
         ...
         })).apply(p_258968_, MobSpawnSettings.SpawnerData::new);
      });
