...
public class WorldPresets {
   ...
   public static void bootstrap(BootstapContext<WorldPreset> p_256172_) {
      (new WorldPresets.Bootstrap(p_256172_)).run();
   }
   ...
   static class Bootstrap {
      ...
      Bootstrap(BootstapContext<WorldPreset> p_256588_) {
         ...
         this.netherStem = new LevelStem(holder, new NoiseBasedChunkGenerator(MultiNoiseBiomeSource.Preset.NETHER.biomeSource(this.biomes), holder1));
